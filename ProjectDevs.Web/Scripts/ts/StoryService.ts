...
class StoryService {
    ...
    private saveQuickStoryModalForm = this.createEditQuickStoryModal.find('#story-form');
    ...
    constructor(private isMyPage: boolean, private apiService: ApiService, private isDetailPage = false, private isProjectDetailPage = false) {
        this.init();
    }
    ...
    resetQuickProjectStoryForm() {
        ...
        this.saveQuickStoryModalForm.find('[name=PriorityRanking]').val(0).trigger('input');
    ...
    private init() {
        ...
        this.saveQuickStoryBtn.on('click', () => {
            ...
            MainLoader.show();
            const storySaveUrl: string = UrlHelper.GetProjectStoriesUrl(ApiUrl.ProjectStoryQuickCreate, projectId, 0);
