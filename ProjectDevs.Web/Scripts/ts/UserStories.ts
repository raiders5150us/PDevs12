...
$(function () {
    ...
    const storyService = new StoryService(isMyPage, apiService, false);
    const ddlService = new DdlService(apiService);

    MainLoader.show();
    $.when(ddlService.setTeamsDdl(),ddlService.setProjectsDdl(), ddlService.setStoryStatusesDdl(), ddlService.setSprintsDdl(), ddlService.setStoryTypesDdl())
