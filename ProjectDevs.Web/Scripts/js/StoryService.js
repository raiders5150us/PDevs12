...
var StoryService = /** @class */ (function () {
    function StoryService(isMyPage, apiService, isDetailPage, isProjectDetailPage) {
        ...
        this.saveQuickStoryModalForm = this.createEditQuickStoryModal.find('#story-form');
    ...
    StoryService.prototype.init = function () {
        ...
        this.saveQuickStoryBtn.on('click', function () {
            ...
            MainLoader.show();
            var storySaveUrl = UrlHelper.GetProjectStoriesUrl(ApiUrl.ProjectStoryQuickCreate, projectId, 0);
